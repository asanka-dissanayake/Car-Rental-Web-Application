                        ...
                        <div class="user_profile_info gray-bg padding_4x4_40">
                            ...
                            <div>
                                ...
                                <div class="md-3">
                                    ...
                                    <input onChange="display_image(this.files[0])" class="form-control form-control-sm" type="file"
                                        id="formFilesm" accept="">
                                        ...
                                        <form method="post">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control white_bg"
                                                    value="<?php echo htmlentities($result->EmailId); ?>" name="emailid" id="email"
                                            ...
                                            <button id="btn2">add another phone number</button>
