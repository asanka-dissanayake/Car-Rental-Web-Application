...
if (isset($_POST['submit'])) {
	...
	move_uploaded_file($_FILES["img1"]["tmp_name"], "admin//vehicleimages/" . $_FILES["img1"]["name"]);
	...
	move_uploaded_file($_FILES["img6"]["tmp_name"], "admin/img/vehicleimages/" . $_FILES["img5"]["name"]);
	$sql = "INSERT INTO tblvehicles(VehiclesTitle,VehiclesBrand,VehiclesOverview,PricePerDay,FuelType,ModelYear,SeatingCapacity,Vimage1,Vimage2,Vimage3,Vimage4,Vimage5,AirConditioner,PowerDoorLocks,AntiLockBrakingSystem,BrakeAssist,PowerSteering,DriverAirbag,PassengerAirbag,PowerWindows,CDPlayer,CentralLocking,CrashSensor,LeatherSeats,Vimage6,FromDate,ToDate) VALUES(:vehicletitle,:brand,:vehicleoverview,:priceperday,:fueltype,:modelyear,:seatingcapacity,:vimage1,:vimage2,:vimage3,:vimage4,:vimage5,:airconditioner,:powerdoorlocks,:antilockbrakingsys,:brakeassist,:powersteering,:driverairbag,:passengerairbag,:powerwindow,:cdplayer,:centrallocking,:crashcensor,:leatherseats,:vimage6,:fromdate,:todate)";
				...
				<div class="col-md-3 col-sm-3">
					...
					<div class="col-md-6 col-sm-8">
						<div class="profile_wrap">
							<h5 class="uppercase underline">Post Vehicle </h5>
							...
							<div class="row">
								...
								<div class="panel-body">
									<form method="post" class="form-horizontal" enctype="multipart/form-data">
										...
										<div class="form-group">
											<label class="col-sm-2 control-label">Price Per Day(in Pounds)<span
													style="color:red">*</span></label>
											<div class="col-sm-4">
										...
										<div class="form-group">
											...
											<div class="col-sm-4">
												<select class="form-control" name="modelyear" required>
													<option value=""> Select </option>
										...
										<label class="col-sm-2 control-label">Seating Capacity<span
											...
											<div class="col-sm-4">
												<select class="form-control" name="seatingcapacity" required>
													<option value=""> Select </option>
