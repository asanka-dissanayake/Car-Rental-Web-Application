													...
													foreach ($results as $result) { ?>
														...
														<form method="post" class="form-horizontal" enctype="multipart/form-data">
															<div class="form-group">
																...
																<div class="col-sm-4">
																	<input type="text" name="vehicletitle" class=""
																		...
																		<div class="col-sm-3">
																			<?php if ($result->DriverAirbag == 1) {
																				...
																				<div class="checkbox checkbox-inline">
																					...
																					<label for="inlineCheckbox3"> Passenger Airbag
																					</label>
																				</div>
																			<?php } else { ?>
																				<div class="checkbox checkbox-inline">
																			...
																			<div class="col-sm-3">
																				<?php if ($result->CentralLocking == 1) {
																					...
																					<div class="checkbox  checkbox-inline">
																						...
																						<label for="inlineCheckbox2">Central
																							Locking</label>
																					</div>
																				<?php } else { ?>
																					<div
																			...
																			<div class="col-sm-3">
																				<?php if ($result->CrashSensor == 1) {
																					...
																					<div class="checkbox checkbox-inline">
																						...
																						<label for="inlineCheckbox3"> Crash Sensor
																						</label>
																					</div>
																				<?php } else { ?>
																					<div class="checkbox checkbox-inline">
																			...
																			<div class="col-sm-3">
																				<?php if ($result->CrashSensor == 1) {
																					...
																					<div class="checkbox checkbox-inline">
																						...
																						<label for="inlineCheckbox3"> Leather Seats
																						</label>
																					</div>
																				<?php } else { ?>
																					<div class="checkbox checkbox-inline">
																...
																<div class="form-group">
																	<div class="col-sm-8 col-sm-offset-2">
																		...
																		<a class="btn btn-primary " name="back"
																			href="manage-vehicles.php">Back</a>
																	</div>
																</div>
															</div>
