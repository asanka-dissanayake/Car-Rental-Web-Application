    ...
    <div class="container">
      <div class="row">
        <div class="col-sm-3 col-md-2">
          <div class="logo"> <a href="index.php"><img src="assets/images/sharecar.png" alt="image" width="80"
                height="70" /></a> </div>
        </div>
            ...
            <li class="dropdown"> <a href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i
              ...
              <ul class="dropdown-menu">
                <?php if ($_SESSION['login']) { ?>
                  ...
                  <li><a href="my-booking.php">Post Vehicles</a></li>
                  <li><a href="post-testimonial.php">Listed Vehicles</a></li>
                  <li><a href="logout.php">Sign Out</a></li>
                <?php } else { ?>
                  <li><a href="#loginform" data-toggle="modal" data-dismiss="modal">Profile Settings</a></li>
                  <li><a href="#loginform" data-toggle="modal" data-dismiss="modal">Update Password</a></li>
                  <li><a href="#loginform" data-toggle="modal" data-dismiss="modal">Post Vehicle</a></li>
                  <li><a href="#loginform" data-toggle="modal" data-dismiss="modal">Listed Vehicles</a></li>
