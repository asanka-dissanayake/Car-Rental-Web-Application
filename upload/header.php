    ...
    <div class="container">
      <div class="row">
        <div class="col-sm-3 col-md-2">
          <div class="logo"> <a href="index.php"><img src="assets/images/logo.jpg" alt="image" width="80" height="70"/></a> </div>
        </div>
        <div class="col-sm-9 col-md-10">
          <div class="header_info">
            <div class="header_widgets">
              <div class=""><!-- <i class="fa fa-envelope" aria-hidden="true"></i>--> </div>
              <p class="uppercase_text">Share Car </p>
               </div>
           <!-- <div class="header_widgets">
...
?>
 <div class="login_btn"> <a href="#loginform" class="btn btn-xs uppercase" data-toggle="modal" data-dismiss="modal">   Login   </a> </div>
  <div class="login_btn"> <a href="#signupform" class="btn btn-xs uppercase" data-toggle="modal" data-dismiss="modal"> Register</a> </div>
<?php }
else{
...
foreach($results as $result)
	{
	 ...
	 //echo 'div style ="font-size:1.25em;color:red">'. htmlentities($result->FullName ).'</div>'; }}	
 echo '<div style="font-size:30px; color:#ffd700">' .  htmlentities($result->FullName ) . '</div>';}}
}
			  ?>
          </div>
        </div>
...
foreach($results as $result)
	{
	 ...
	 echo htmlentities($result->FullName); }}?><i class="fa fa-angle-down" aria-hidden="true"></i></a>
          ...
          <!--<li><a href="my-testimonials.php">My Review</a></li>
			<li><a href="owner/my-vehicles.php">My cars</a></li>-->	  
